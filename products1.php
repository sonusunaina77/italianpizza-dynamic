					...
					<div class="span12">								
						<ul class="thumbnails listing-products">
									<?php
										...
										$page_query = mysql_query("SELECT COUNT(*) FROM food where category = 'veg'");
										$pages = ceil(mysql_result($page_query, 0) / $per_page);

										$page = (isset($_GET['page'])) ? (int)$_GET['page'] : 1;
										$start = ($page - 1) * $per_page;
										
										$query = mysql_query("SELECT * FROM food where category = 'veg' LIMIT $start, $per_page");
